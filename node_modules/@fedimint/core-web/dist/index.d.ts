...
declare const WorkerMessageTypes: readonly ["init", "initialized", "rpc", "log", "open", "join", "error", "unsubscribe", "cleanup", "parseInviteCode"];
...
declare class LightningService {
    ...
    parseBolt11Invoice(invoice: string): Promise<JSONValue>;
}
